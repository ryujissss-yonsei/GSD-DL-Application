# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 16:59:55 2024
...
class PatchTST(nn.Module):
    def __init__(self, channel, window_size, forcast_size, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        target_window = forcast_size
        
        n_layers = 2   # num of encoder layers
